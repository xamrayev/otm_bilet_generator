...
for index, til in enumerate(til_options):
    ctk.CTkRadioButton(frame1, text=til, variable=til_var, value=til).grid(row=0, column=index + 1,)
...
open_file_button = ctk.CTkButton(frame1, text="Open File", command=open_file_path)
open_file_button.grid(row=9, column=0, pady=10)

# CTkEntry for file path
file_path_entry = ctk.CTkEntry(frame1)
file_path_entry.grid(row=9, column=1,)

# "Tayyorlca" CTkbutton
tayyorla_button = ctk.CTkButton(frame1, text="Tayyorla", command=tayyorla_clicked)
tayyorla_button.grid(row=10, column=0,)
namuna_test_button = ctk.CTkButton(frame1, text="Namuna fayl", command=test_template)
namuna_test_button.grid(row=10, column=1,)
...
til_options = ["uz", "ru"]
for index, til in enumerate(til_options):
    ctk.CTkRadioButton(frame2, text=til, variable=til_var2, value=til).grid(row=0, column=index + 1, )
...
# CTkButton to open file dialog for file path
open_file_button = ctk.CTkButton(frame2, text="Open File", command=open_file_path2)
open_file_button.grid(row=9, column=0, pady=10)
...
# "Tayyorlca" CTkbutton
tayyorla_button2 = ctk.CTkButton(frame2, text="Tayyorla", command=tayyorla2_clicked)
tayyorla_button2.grid(row=10, column=0,)

namuna_savol_button = ctk.CTkButton(frame2, text="Namuna fayl", command=savol_template)
namuna_savol_button.grid(row=10, column=1)
